...
export class FilesUploadRepository{
        async uploadImage(file: Express.Multer.File): Promise<UploadApiResponse> {
            try {
                ...
                throw new BadRequestException('Error uploading image to Cloudinary', error.message)
            }
        }
        ...
        async generateSecureUrl(publicId: string) {
            ...
            // configuramos la URL para que la imagen tenga los valores que queremos
                ...
                throw new BadRequestException('Error generating secure URL', error.message)
